...
/**
 * Represents one stage in the world generation process. A {@link Generator} is
 * constructed with a {@link World} and an {@link Random}. When {@link #generate()}
 * is called, the {@link World} instance will be modified.
 *
