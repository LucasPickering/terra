...
import me.lucaspickering.groundwar.board.Flag;
import me.lucaspickering.groundwar.board.PlayerInfo;
import me.lucaspickering.groundwar.board.tile.FortTile;
import me.lucaspickering.groundwar.board.tile.ForwardFortTile;
import me.lucaspickering.groundwar.board.tile.GoldTile;
import me.lucaspickering.groundwar.board.tile.MountainTile;
...
public class BoardHandler {
    ...
    private void loadTilesFromFile(String fileName) throws IOException {
        ...
        try {
            ...
            final URL resourceUrl = TerrainGen.getResource(Constants.BOARD_PATH, fileName);
    ...
    public void saveBoard(Board board) {
        ...
        for (int i = 1; saveFile == null || saveFile.exists(); i++) {
            saveFile = new File(TerrainGen.getResource(Constants.SAVE_PATH, "save" + i).getPath());
        }
