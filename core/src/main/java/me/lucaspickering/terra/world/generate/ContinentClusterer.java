...
/**
 * Clusters all land tiles in the world together to become continents. This should probably be used
 * after everything that modifies elevation is done, so that you know shorelines won't change
 * anymore. It should obviously be done before any operations that rely on having accurate continent
 * clusters.
 */
