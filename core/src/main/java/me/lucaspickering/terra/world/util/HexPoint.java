 ...
 * described by http://www.redblobgames.com/grids/hexagons/, so {@code x + y + z == 0}. Technically
 * this means that keeping z around is redundant, but it makes certain things more elegant (like the
 * distance calculation). Some computations, like {@link #equals} and {@link #hashCode}, don't use z
 * for efficiency purposes.
 */
public class HexPoint implements Comparable<HexPoint>, HexPointable {
    ...
    /**
     * Constructs a new HexPoint using the given x and y coordinates. The z coordinate is calculated
     * from the x and y.
     *
     * @param x the x coord
     * @param y the y coord
    ...
    /**
     * Constructs a new HexPoint using the given coordinates. Verifies that {@code x + y + z == 0}
     * first.
     *
     * @param x the x coord
     * @param y the y coord
    ...
    /**
     * Rounds the given fractional coordinate values into valid integer coordinates, and creates a
     * {@link HexPoint} from those. The round point closest to the given fractional point will be
     * returned.
     *
