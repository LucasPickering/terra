...
public class TileSet extends HexPointSet<Tile> {
    ...
    /**
     * Gets all tile points in the given range of the given tile. A tile will be included in the
     * output if it is in this collection, and it is within {@code range} steps of {@code tile}. For
     * example, giving a range of 0 returns just the given tile, 1 returns the tile and all adjacent
     * tiles, etc.
     *
    ...
    /**
     * Gets the set of all tiles that are in this collection and exactly the given distance from the
     * given tile.
     *
